...
//           <h2>Our Services</h2>
//           <p>We provide holistic wellness solutions through our comprehensive fitness and mental health programs designed to transform your lifestyle.</p>
          
//           <div className="services-grid">
//             <div className="service-card">
//               <div className="service-icon">🧘</div>
//               <h3>Yoga Classes</h3>
//               <p>Experience inner peace and physical strength through our guided yoga sessions. Perfect for beginners and advanced practitioners alike.</p>
//             </div>
            
//             <div className="service-card">
//               <div className="service-icon">💪</div>
//               <h3>Fitness Training</h3>
//               <p>Personalized fitness programs designed to help you achieve your health goals with expert guidance and support.</p>
//             </div>
            
//             <div className="service-card">
//               <div className="service-icon">🧠</div>
//               <h3>Wellness Lab</h3>
//               <p>Comprehensive wellness assessments and personalized recommendations to optimize your mental and physical health.</p>
//             </div>
//           </div>
//         </div>
//       </section>
